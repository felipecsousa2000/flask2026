...
# ------------------------------
# No Render: defina STRIPE_SECRET_KEY nas Environment Variables
stripe.api_key = os.getenv("STRIPE_SECRET_KEY")

# URL base do seu app no Render (defina nas Environment Variables também)
...
def comprar(item_id):
    ...
    # Garantir que o preço está em centavos e é inteiro
    try:
